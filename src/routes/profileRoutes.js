...
router.get('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, profileSchema_1.default.find()];
            case 1:
                profiles = _a.sent();
                res.json(profiles);
                return [3 /*break*/, 3];
...
router.post('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, email, phone, profile, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name_1 = _a.name, email = _a.email, phone = _a.phone;
                profile = new profileSchema_1.default({ name: name_1, email: email, phone: phone });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, profileSchema_1.default.findByIdAndDelete(id)];
            case 1:
                profile = _a.sent();
                if (!profile) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, profileSchema_1.default.findByIdAndUpdate(id, { name: name_2 }, { new: true })];
            case 1:
                profile = _a.sent();
                if (!profile) {
                    return [2 /*return*/, res.status(404).json({ message: 'Profile not found' })];
